...
public class ImGuiController : IDisposable
{
    ...
    private void ApplyImGuiDarkStyle()
    {
        ...
        style.Colors[(int)ImGuiCol.TabSelected] = new Vector4(0.23f, 0.23f, 0.24f, 1.00f);
        style.Colors[(int)ImGuiCol.TabSelectedOverline] = new Vector4(0.08f, 0.08f, 0.09f, 1.00f);
        style.Colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.13f, 0.14f, 0.15f, 1.00f);
